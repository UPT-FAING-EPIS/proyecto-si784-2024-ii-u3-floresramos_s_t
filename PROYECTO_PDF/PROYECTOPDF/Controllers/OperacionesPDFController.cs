...
namespace PROYECTOPDF.Controllers
{
    ...
    {
        private readonly IOperacionesPDFRepository _operacionesPDFRepository;

    public OperacionesPDFController(IOperacionesPDFRepository operacionesPDFRepository) // Cambia a la interfaz
    {
